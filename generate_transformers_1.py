...
def main():
    ...
    print("Start generating of seeds with temperature: ", args.temperature)

    while index <= args.number_gen:

        random_seed = randint(0, args.seed)
        set_seed(random_seed, args.n_gpu)
